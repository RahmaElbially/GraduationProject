...
class TechnicalEducationScreen extends StatefulWidget {
  const TechnicalEducationScreen({Key? key}) : super(key: key);

  @override
  State<TechnicalEducationScreen> createState() => _TechnicalEducationScreenState();
}

class _TechnicalEducationScreenState extends State<TechnicalEducationScreen> {
  int _currentIndex = 2;
  List _screens=[PersonalScreen(),NotificationScreen(),TechnicalEducationScreen(),];
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    itemBuilder:(context,index){
                      return HorizontalListViewTech(image: "assets/images/a77c81bc7bebde235ba9c5e066cc9847.png", title: "قسم الإقتصاد المنزلي");
                    },
