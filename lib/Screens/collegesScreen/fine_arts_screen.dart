...
class FineArtsScreen extends StatefulWidget {
  const FineArtsScreen({Key? key}) : super(key: key);

  @override
  State<FineArtsScreen> createState() => _FineArtsScreenState();
}

class _FineArtsScreenState extends State<FineArtsScreen> {
  int _currentIndex = 2;
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                        itemBuilder:(context,index){
                          return HorizontalListViewFine(image: "assets/images/ben-white-oAU4YHeMFSI-unsplash.png", title: "قسم النحت");
                        },
